...
object paredes{
	...
	method agregarParedesNivel1() {
		...
		game.addVisual(new Pared(position = game.at(18,4),  imagen = "paredes/paredInferiorV.png"))
		...
		game.addVisual(new Pared(position = game.at(20,2),  imagen = "paredes/paredUnionIzquierdoHV.png"))
	}
	method agregarParedesNivel2() {
		
		// Verticales
		game.addVisual(new Pared(position = game.at(2,0),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(2,1),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(2,2),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(2,3),  imagen = "paredes/paredCompleta.png"))

		game.addVisual(new Pared(position = game.at(2,11),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(2,12),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(2,13),  imagen = "paredes/paredCompleta.png"))
		
		game.addVisual(new Pared(position = game.at(4,2),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(4,3),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(4,4),  imagen = "paredes/paredCompleta.png"))

		game.addVisual(new Pared(position = game.at(4,9),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(4,10),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(4,11),  imagen = "paredes/paredCompleta.png"))

		game.addVisual(new Pared(position = game.at(6,2),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(6,3),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(6,4),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(6,5),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(6,6),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(6,7),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(6,8),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(6,9),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(6,10),  imagen = "paredes/parparedCompletaedV.png"))
		game.addVisual(new Pared(position = game.at(6,11),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(6,12),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(6,13),  imagen = "paredes/paredCompleta.png"))
		
		game.addVisual(new Pared(position = game.at(8,3),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(8,4),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(8,5),  imagen = "paredes/paredCompleta.png"))
		
		game.addVisual(new Pared(position = game.at(8,9),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(8,10),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(8,11),  imagen = "paredes/paredCompleta.png"))

		game.addVisual(new Pared(position = game.at(12,2),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(12,3),  imagen = "paredes/paredCompleta.png"))

		game.addVisual(new Pared(position = game.at(12,5),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(12,6),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(12,7),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(12,8),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(12,9),  imagen = "paredes/paredCompleta.png"))

		game.addVisual(new Pared(position = game.at(14,10),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(14,9),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(14,8),  imagen = "paredes/paredCompleta.png"))
		...
		game.addVisual(new Pared(position = game.at(14,5),  imagen = "paredes/paredCompleta.png"))
		...
		game.addVisual(new Pared(position = game.at(16,13),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(16,12),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(16,11),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(16,10),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(16,9),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(16,8),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(16,7),  imagen = "paredes/paredCompleta.png"))

		game.addVisual(new Pared(position = game.at(16,3),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(16,2),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(16,1),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(16,0),  imagen = "paredes/paredCompleta.png"))		
		...
		game.addVisual(new Pared(position = game.at(15,5),  imagen = "paredes/paredSinBordesH.png"))
		game.addVisual(new Pared(position = game.at(16,5),  imagen = "paredes/paredCompleta.png"))
		game.addVisual(new Pared(position = game.at(17,5),  imagen = "paredes/paredSinBordesH.png"))
		game.addVisual(new Pared(position = game.at(18,5),  imagen = "paredes/paredDerechoUnionHV.png"))
