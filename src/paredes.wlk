...
object paredes{
	...
	method agregarParedesNivel1() {
		...
		// Verticales
		game.addVisual(new Pared(position = game.at(2,0),  imagen = "paredes/paredV.png"))
		...
		game.addVisual(new Pared(position = game.at(2,13),  imagen = "paredes/paredUnionHV.png"))
		...
		game.addVisual(new Pared(position = game.at(4,9),  imagen = "paredes/paredInferiorV.png"))
		...
		game.addVisual(new Pared(position = game.at(6,13),  imagen = "paredes/paredUnionHV.png"))


		game.addVisual(new Pared(position = game.at(8,0),  imagen = "paredes/paredV.png"))
		game.addVisual(new Pared(position = game.at(8,1),  imagen = "paredes/paredV.png"))
		game.addVisual(new Pared(position = game.at(8,1),  imagen = "paredes/paredSuperiorV.png"))
		...
		game.addVisual(new Pared(position = game.at(8,5),  imagen = "paredes/paredSuperiorV.png"))
		
		game.addVisual(new Pared(position = game.at(8,9),  imagen = "paredes/paredInferiorV.png"))
		...
		game.addVisual(new Pared(position = game.at(12,1),  imagen = "paredes/paredInferiorV.png"))
		game.addVisual(new Pared(position = game.at(12,2),  imagen = "paredes/paredV.png"))
		game.addVisual(new Pared(position = game.at(12,3),  imagen = "paredes/paredSuperiorV.png"))

		game.addVisual(new Pared(position = game.at(12,5),  imagen = "paredes/paredInferiorV.png"))
		...
		game.addVisual(new Pared(position = game.at(12,9),  imagen = "paredes/paredSuperiorV.png"))
		
				
		// Horizontales
		game.addVisual(new Pared(position = game.at(1,5),  imagen = "paredes/paredBordeIzquierdoH.png"))
		...
		game.addVisual(new Pared(position = game.at(4,5),  imagen = "paredes/paredUnionHVConTecho.png"))
